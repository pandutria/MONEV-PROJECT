                            ...
                            <thead>
                                <tr className="bg-linear-to-r from-gray-50 to-gray-100">
                                    <th className="px-6 py-6 text-left min-w-45">
                                        <div className="bg-linear-to-r from-primary to-orange-600 text-white rounded-2xl px-6 py-4 font-poppins-bold text-sm shadow-lg transform hover:scale-105 transition-transform">
                                            Satuan Kerja
                                        </div>
                                    </th>
