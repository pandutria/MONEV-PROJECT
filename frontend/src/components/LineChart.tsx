...
export default function LineChart({ selectedRealization }: LineChartProps) {
    ...
    return (
        <div className="w-full lg:h-screen h-auto flex items-center p-4 lg:p-8 my-24 lg:my-36 bg-linear-to-br from-orange-50/30 via-white to-blue-50/20" data-aos="fade-up" data-aos-duration="1000">
