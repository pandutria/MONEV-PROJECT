    ...
    return (
        <div>
            ...
            <div className="flex flex-row w-full gap-4 items-center">
                ...
                <button onClick={onClick} className='font-poppins-regular text-white bg-primary px-4 py-2.5 w-32.5 text-[12px] rounded-lg cursor-pointer border-2 border-primary hover:bg-transparent hover:text-primary transition-all'>List Tender</button>
            </div>
        </div>
    )
}
